        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "var(--theme-text-muted)" }}>
              最近 {readingHistory.length} 次解读记录
            </p>
          </div>
        </div>
...
function HistoryCard({ record, index }: { record: ReadingRecord; index: number }) {
        ...
        {record.cards.map((c, i) => (
          <span
            ...
            style={{
              ...
              color: c.orientation === "upright" ? "var(--theme-accent-secondary)" : "var(--theme-text-muted)",
            }}
          >
            {c.position}: {c.name}
